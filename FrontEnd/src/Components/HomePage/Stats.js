            ...
            <div className="mb-4 mb-lg-0 col-lg-7">
                <div className="h-100 card">
                    ...
                    <div className="card-body">
                        <h4 className="header-title mb-3">Test Stats</h4>
                        <Chart
                        ...
                        <div className="d-flex card-body">
                            ...
                            <div className="w-100 align-items-center row">
                                <div className="mb-4 mb-sm-0 col-sm-5">
                                    <h2 className="mb-0 d-flex align-items-center h1">
                                        <span>86.4</span>
                                        <span className="dot bg-green d-inline-block ms-3"></span>
                                    </h2>
                                    <span className="text-muted text-uppercase small">Work hours</span>
                                    <hr />
